...
class HabitRepositoryImpl @Inject constructor(
     ...
     */
    override fun observeTodaysHabits(): Flow<List<HabitWithStatus>> = flow {
    ...
    override suspend fun toggleCompletionToday(habitId: Long) =
        toggleCompletion(habitId, dateProvider.today())
}
